...
//-->
	...
	<body bgcolor="#FFFFFF" background="images/index_bg.jpg" leftmargin="0"
		...
		<table width="780" border="0" align="center" cellpadding="0"
			...
			<tr align=center>
				<td colspan="9">
					<img src="images/20037233554511044.jpg" width="760" height="133"
						alt="那一年冬天　LiuY's MessageBoard">
				</td>
			</tr>
			<tr>
				<td>
					<img src="images/savalo_blog_green_04.jpg" width="18" height="24"
						alt="">
				</td>
				...
				<td background="images/savalo_blog_green_05.jpg">
					<a href="jsp/message/message.jsp"
				...
				<td background="images/savalo_blog_green_05.jpg">
					<a href="Exit"
						...
						onMouseOut="MM_swapImgRestore()"><img
							src="images/savalo_blog_green_11.jpg" alt="退出" name="Image6"
							width="69" height="24" border="0" id="Image6"> </a>
				</td>
				<td>
					<img src="images/savalo_blog_green_12.jpg" width="18" height="24"
						alt="">
				</td>
			</tr>
		</table>
		...
		<table width="780" border="0" align="center" cellpadding="0"
			...
			<tr align=center>
				<td>
					<img src="images/046.jpg" width="760" height="30"
						alt="版权所有　&copy; 2008  Author By LiuY">
				</td>
			</tr>
		</table>
	</body>
