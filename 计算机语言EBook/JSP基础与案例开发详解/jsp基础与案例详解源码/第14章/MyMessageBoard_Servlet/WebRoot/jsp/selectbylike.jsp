...
<%
	...
	int sum_page = 1;
	//总记录数
	int sum_row = impl.getByLikeCount((String) session
			.getAttribute("like"));
	try {
	...
	List list = impl.selectByLike(
			(String) session.getAttribute("like"), page_count, row);
%>
<html>
	<head>
		<title>那一年冬天</title>
			...
			<tr>
				...
				<td width="189" rowspan="2" align="center" valign="top"
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							<td align="center">
								<img src="../images/20037233554511045.jpg" width="179" height="20"
									　atl="搜索BLOG文章">
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td align="center">
								<img src="../images/20037233554511045.jpg" width="179" height="20" alt="友情链接">
							</td>
						</tr>
						<tr>
							<td align="center">
				...
				<td width="570" rowspan="2" align="center" valign="top"
					...
					<form name="spage" method="post" action="selectbylike.jsp">
						<table width="95%" border="0" align="center" cellpadding="0"
							...
							<tr>
								...
								<td>
									...
									%>
									<div align="center">
										<input type="button" value="首 页" onClick="openPage(1)"
											<%=page_count == 1 ? "disabled" : ""%>>

										<input type="button" value="上一页"
											onClick="openPage(<%=page_count - 1%>)"
											<%=page_count == 1 ? "disabled" : ""%>>
										...
										<input type="button" value="尾 页"
											onClick="openPage(<%=sum_page%>)"
											<%=page_count == sum_page ? "disabled" : ""%>>
										<input type="hidden" name="page" value="">
										&nbsp;
										<font color="red" size="5"><%=page_count%> </font> /
										<font color="red" size="5"><%=sum_page%> </font> &nbsp; 跳转到
