...
<%
	...
	Message message = impl.getOneMessage(id);	
%>
<html>
	<head>
		<title>那一年冬天</title>
					...
					<table width="96%" border="0" cellspacing="0" cellpadding="2">						
						<tr>
							<td class="context">
								<table width="100%" border="0" cellpadding="0" cellspacing="0"
									...
									<tr>
										<td>
											<strong><%=message.getMotif()%>&nbsp;&nbsp;作者：<%=message.getName()%></strong>
										</td>
										<td>&nbsp;
								...
								<br>
								<div align="center">
									<textarea name="message" cols="65" rows="35" class="fullmessage" readonly="readonly"><%=message.getContext()%></textarea>
								</div>
								<br>								
							</td>
						</tr>
						<tr>
							<td class="context">
								...
								<div align="right">			
									<a href="../../index.html">返回留言列表</a>
									<a href="../manager/repeat.jsp?id=<%=message.getId()%>">回复留言</a>|
									<a href="../manager/delete.jsp?id=<%=message.getId()%>">删除留言</a>|
									<a href="../manager/updata.jsp?id=<%=message.getId()%>">修改留言</a> 
								</div>
								<%
									}
								%>
