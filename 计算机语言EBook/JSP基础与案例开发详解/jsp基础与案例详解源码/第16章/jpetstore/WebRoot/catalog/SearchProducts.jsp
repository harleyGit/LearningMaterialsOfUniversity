	...
	<tr>
		<td bgcolor="#FFFF88">
			<html:link page="/shop/index.shtml">
				<b><font color="BLACK" size="2">&lt;&lt; Main Menu</font>
				</b>
			</html:link>
		</td>
	</tr>
...
<table align="center" bgcolor="#008800" border="0" cellspacing="2"
	...
	<logic:iterate id="product" name="productList">
		<tr bgcolor="#FFFF88">
			...
			<td>
				<b><html:link paramId="productId" paramName="product"
						paramProperty="productId" page="/shop/viewProduct.shtml">
						<font color="BLACK"><bean:write name="product"
								property="productId" />
						</font>
					</html:link>
				</b>
	...
	<tr>
		<td bgcolor="#FFFFFF" colspan="3">
			<logic:notEqual name="productList" property="firstPage" value="true">
				<a href="switchSearchListPage.shtml?pageDirection=previous"><img
						src="../images/button_prev.gif" border="0">
				</a>
			</logic:notEqual>
			<logic:notEqual name="productList" property="lastPage" value="true">
				<a href="switchSearchListPage.shtml?pageDirection=next"><img
						src="../images/button_next.gif" border="0">
				</a>
			</logic:notEqual>
		</td>
	</tr>
