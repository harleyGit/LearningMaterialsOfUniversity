...
<font size="2"><i><br />Shop for more of your <br />favorite pets here.</i></font>
  ...
  <logic:notEqual name="myList" property="firstPage" value="true" >
    <a href="switchMyListPage.shtml?pageDirection=previous&account.listOption=<bean:write name="accountBean" property="account.listOption"/>&account.bannerOption=<bean:write name="accountBean" property="account.bannerOption"/>"><img src="/sshstore/images/button_prev.gif" border="0"></a>
  </logic:notEqual>
  <logic:notEqual name="myList" property="lastPage" value="true" >
    <a href="switchMyListPage.shtml?pageDirection=next&account.listOption=<bean:write name="accountBean" property="account.listOption"/>&account.bannerOption=<bean:write name="accountBean" property="account.bannerOption"/>"><img src="/sshstore/images/button_next.gif" border="0"></a>
  </logic:notEqual>
  </td>
  </tr>
