...
<html>
	<head>
		<title>${configlist.forumName }--『 ${boardinfo } 』 回复
			${bbslist.title }</title>
					...
					<table cellpadding=0 cellspacing=1 border=0 width="100%">
						<tr>
							<td align=left valign=middle bgcolor="#99ccff">
								<font color="#000000">&nbsp; </font><span class="t">原贴：
									${bbslist.title} </span>
							</td>
						</tr>
					</table>
					...
					<table cellpadding=0 cellspacing=0 width="80%"
						...
						<tr>
							<td width=32 align=left valign=top>							
								<img src='pic/${bbslist.heart }' border=0 alt=发贴心情>
								&nbsp;
							</td>
							<td style="LEFT: 0px; WIDTH: 100%; WORD-WRAP: break-word">
								<font face=宋体 color=#333333> <b>${bbslist.title
										}[${bbslist.type}] </b> <br> </font>
							</td>
						</tr>
						<tr>
							<td colspan="2">
			...
			<tr>
				...
				<td bgcolor="#f2f8ff">						
					<table cellpadding=0 cellspacing=1 border=0 width="100%">
						<tr>
							<td align=left valign=middle bgcolor="#99ccff">
								<font color="#000000">&nbsp; </font><span class="t">回复如下：
									</span>
							</td>
						</tr>
					</table>
															...
															<tr>
																<td height="100%">
																	...
																	<input name="hidden" type="hidden" id="ContentFlag"
																		value="0">
																	<form action="bbs?path=add" name="frmAdd"
																		method="post" onsubmit="subchk()">
																		<iframe id="HTMLEditor" width="500" height="80%"
																			scrolling="yes" frameborder="1" src="12323"
																			title="1233">
																		</iframe>
																		<p align="left">
																			请选择心情：
																		...
																		<input type="hidden" name="ftype" value="回复">
																		<input type="hidden" name="ftitle">
																		<input type="hidden" name="content">
																		<input type="hidden" name="child" value="${AnnounceID}">	
