...
{ 
	...
	document.frmAdd.vote.value=document.frmTmp.vote.value;	
		
	if(document.frmTmp.type1.checked){
		document.frmAdd.votetype.value=0;
	}else{
		document.frmAdd.votetype.value=1;
	}
					...
					<table cellpadding=0 cellspacing=1 border=0 width="100%">
						<tr>
							<td align=left valign=middle bgcolor="#99ccff">
								<font color="#000000">&nbsp; </font><span class="t">发起投票</span>
							</td>
						</tr>
					</table>
				</td>
					...
					<table width="100%" cellpadding=4 cellspacing=0>
						<tr>
							<td bgcolor="#f2f8ff" valign=top width="20%">
								<p>
									<b><font color="">投票项目 </font> </b>
									<br>
									<br>
								</p>
								<ul>
									<li>
										<font color="">每行一个投票项目，最多10个</font>
									</li>
									<li>
										<font color="">超过自动作废，空行自动过滤</font>
									</li>
								</ul>
								<p>
									<BR>
													...
													<td>
														<table width="67%" border=0 cellpadding=0 cellspacing=0
															...
															<tr>
																<td>
																	请选择投票的类型 ：
																	<input id="type1" type="radio" name="vtype" value="0">
																	单选
																	<input id="type2" type="radio" name="vtype" value="1">
																	多选
																</td>
															</tr>
															<tr>
																<td>
																	<textarea name="vote" cols="50" rows="10"></textarea>
																</td>
															</tr>
															</form>
															<tr>
															...
															<tr>
																<td height="100%">
																	...
																	<form action="bbs?path=add" name="frmAdd" method="post"
																		onsubmit="subchk()">
																		<iframe id="HTMLEditor" width="500" height="65%"
																			scrolling="yes">
																		</iframe>
																		<p align="left">
																			请选择心情：
																		...
																		<input type="hidden" name="isvote" value="1">
																	</form>
																</td>
															</tr>
														</table>
