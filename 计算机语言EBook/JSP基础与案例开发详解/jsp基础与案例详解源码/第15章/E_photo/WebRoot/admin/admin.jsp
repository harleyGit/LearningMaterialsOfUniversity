		...
		<table width="900" border="0" align="center" cellpadding="5"
			...
			<tr>
				<td bgcolor="#FFFFFF" valign="middle">
					<form name="form2" method="post" action="leibie?path=update"
			...
			<tr>
				<td height="30" bgcolor="#FFFFFF">
					欢迎您使用本程序(思怡网络相册),想要得到更多支持和更新请访问:
					<a href="http://www.theboy.com/BBS" target="_blank">http://www.theboy.com/BBS</a>上传文件时,注意图片不要过大,建议先进行处理。
				</td>
			</tr>
		</table>
		<br />
