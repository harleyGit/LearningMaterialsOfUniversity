					...
					<table width="766" border="0" cellspacing="0" cellpadding="5"
						...
						<tr>
							<td>
								管理选项：
								<a
									href="/E_photo/leibie?path=adminSel">管理首页</a>
								|
								<a href="/E_photo/leibie?path=select">添加文件</a>
								|
								<a
									href="/E_photo/leibie?path=selAllLB">管理文件</a>
								|
								<a href="/E_photo/systems?path=select">系统设置</a>
								|
								<a href="#">留言管理</a> |
								<a href="admin/modifypsw.jsp">修改密码</a> |
								<a
									href="/E_photo/adminServlet?path=exit"
